...
<div class="content read">
	<h2>List of Requests</h2>
        <a href="crud_create_request.php" class="create-employee">Add a Book Request</a>
	<table>
        <thead>
            <tr>
	...
	<div class="pagination">
		<?php if ($page > 1): ?>
		<a href="crud_read_request.php?page=<?=$page-1?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
		<?php endif; ?>
		<?php if ($page*$records_per_page < $num_request): ?>
		<a href="crud_read_request.php?page=<?=$page+1?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
		<?php endif; ?>
	</div>
</div>
